        ...
        return new Promise(function(resolve, reject) {
            ...
            .then(function(resource) {
                ...
                if(resource && resource.formats) {
                    ...
                    destFile = path.join(resourceDir, languageSlug + '_' + projectSlug + '_' + resourceSlug + '.tstudio');
        ...
        return new Promise(function(resolve, reject) {
            ...
            .then(function() {
                if(opts.compression_method === 'zip') {
                    return utils.zip(dir, dir + '.tstudio.zip');
                } else {
                    return utils.tar(dir, dir + '.tstudio.tar.bz2');
                }
            })
            .then(function() {
                rimraf.sync(dir);
