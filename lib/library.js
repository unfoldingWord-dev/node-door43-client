...
function library(sqliteHelper, opts) {
    ...
    const insertUpdate = function(table, params, unique) {
        ...
        let result = query('select id from ' + table + ' where ' + whereStatements.join(' and ') + ' limit 1', params);
    ...
    this.addSourceLanguage = function(language) {
        ...
        // save();
        // return firstId(query('select id from source_language where slug=? order by id desc', [language.slug]));
    };
    ...
    this.addTargetLanguage = function(language) {
        ...
        // save();
        // return firstId(query('select id from target_language where slug=? order by id desc',
        //     [language.slug]));
    };
    ...
    this.addProject = function(project, source_language_id) {
        ...
        // save();
        //
        // return firstId(query('select id from project where slug=? and source_language_id=? order by id desc',
    ...
    this.addCatalog = function(catalog) {
        ...
        // });
        // save();
        // return firstId(query('select id from catalog where slug=? order by id desc', [catalog.slug]));
    };
    ...
    this.addResource = function(resource, project_id) {
        ...
        //     project: project_id
        // });
        // var resourceId = firstId(query('select id from resource where slug=? and project_id=? order by id desc',
