...
function Library(sqliteHelper, opts) {
     ...
     */
    this.addTempTargetLanguageAssignment = function(temp_target_language_slug, target_language_slug) {
    ...
    this.public_getters = {
        ...
        getTargetLanguage: function(slug) {
            var result = query('select * from (' +
                ...
                '  union' +
                '  select slug, name, "" as anglicized_name, direction, region, 0 as is_gateway_language from temp_target_language' +
         ...
         * @returns {{}|null} the language object or null if it does not exist
         */
        getAssignedTargetLanguage: function(temp_target_language_slug) {
