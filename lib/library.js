    ...
    this.addResource = function(resource, project_id) {
        ...
        for(var format of resource.formats) {
            run('insert or ignore into resource_format' +
                ' (package_version, mime_type, modified_at, url, resource_id)' +
                ' values (\':version\', \':mime\', :mod, \'url\', :id);' +
                'update resource_format set package_version=\':version\', modified_at=\':mod\', url=\':url\'' +
